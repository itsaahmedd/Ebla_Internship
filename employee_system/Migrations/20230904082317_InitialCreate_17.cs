        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Announcement_table_Employee_table_Published_By",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Change = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Request_table", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Request_table_Employee_table_Requested_By",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Task_table_Employee_table_Assigned_By",
                        column: x => x.Assigned_By,
                        principalTable: "Employee_table",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Task_table_Employee_table_Assigned_To",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Announcement_table_Published_By",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Request_table_Requested_By",
                table: "Request_table",
                column: "Requested_By");

            migrationBuilder.CreateIndex(
                name: "IX_Task_table_Assigned_By",
                table: "Task_table",
                column: "Assigned_By");

            migrationBuilder.CreateIndex(
                name: "IX_Task_table_Assigned_To",
                table: "Task_table",
                column: "Assigned_To");
        }
